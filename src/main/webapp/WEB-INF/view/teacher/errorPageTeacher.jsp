...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/teacherPageCss/errorPageTeacher.css"/>
...
<main class="error-container" role="main" aria-labelledby="error-title">
  ...
  <a href="teacherDashboard" class="back-btn" role="button" aria-label="Back to Home">
    ← Back to Home
  </a>
</main>
