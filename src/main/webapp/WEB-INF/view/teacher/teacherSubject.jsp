                ...
                <c:forEach var="subject" items="${subjects}">
                    <div class="subject-card">
                        ...
                        <div class="subject-detail">
                            <i class="fas fa-book-open"></i> Code: ${subject.code}
                        </div>
                        <div class="subject-detail">
                            <i class="fas fa-layer-group"></i> Department: ${subject.department}
                        </div>
                        <div class="subject-detail">
                            <i class="fas fa-calendar-alt"></i> Semester: ${subject.semester}
                        </div>
                    </div>
                </c:forEach>
            </div>
