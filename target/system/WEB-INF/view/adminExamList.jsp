...
<!-- Navbar -->
<div class="navbar">📝 Exam Management</div>
  ...
  <table class="table table-hover text-center align-middle">
    ...
    <c:forEach var="exam" items="${exams}">
      <tr>
        ...
        <%--<td>
          <a href="editExam?id=${exam.id}" class="btn-action">Edit</a>
          <a href="deleteExam?id=${exam.id}" class="btn-action" style="background:#e63946;">Delete</a>
        </td>--%>
      </tr>
    </c:forEach>
    </tbody>
